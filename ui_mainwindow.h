...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pbRead->setObjectName(QStringLiteral("pbRead"));

        verticalLayout->addWidget(pbRead);

        pbVizualize = new QPushButton(centralWidget);
        pbVizualize->setObjectName(QStringLiteral("pbVizualize"));

        verticalLayout->addWidget(pbVizualize);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pbRead->setText(QApplication::translate("MainWindow", "Open file", nullptr));
